...
\begin{enumerate}
	...
	\item Wat is een argument om obesitas niet te pathologiseren?
	      \begin{enumerate}
		      \item Er is geen data die zegt dat obesitas per se een risico is voor andere ziektes of hoge bloeddruk.
		      \item Intussen spreekt men van \textit{globesitas}. Het is dus een probleem van het mens-zijn.
